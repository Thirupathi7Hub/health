...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Our B2B Support & Sales Engineering | Aetheris</title>
        <meta
          name="description"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              <div className="space-y-6">
                <h2 className="text-2xl font-bold text-[#F8FAFC] font-display">
                  Corporate Offices
                </h2>
                <div className="space-y-6">
                  {officeLocations.map((loc, idx) => (
                    <div
                      key={idx}
                      className="p-6 rounded-2xl bg-[#111827] border border-[rgba(255,255,255,0.08)] shadow-premium space-y-4 hover:shadow-premium-hover transition-all duration-300"
                    >
                      <h3 className="text-sm font-bold text-[#F8FAFC]">{loc.title}</h3>
                      <div className="space-y-2 text-xs sm:text-sm text-slate-400">
                        ...
                        <div className="flex gap-3 border-t border-slate-800 pt-2 mt-2">
              ...
              {/* Emergency Call Box */}
              <div className="p-6 rounded-2xl bg-red-500/5 border border-red-500/20 text-[#F8FAFC] space-y-3">
                <div className="flex items-center gap-3">
                  <ShieldAlert className="text-red-500" size={24} />
                  <h4 className="text-sm font-bold uppercase tracking-wider text-red-400">Emergency dispatch hotline</h4>
                </div>
                ...
                <p className="text-sm font-extrabold text-red-400 font-display">
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="p-6 sm:p-8 bg-[#0F172A] border border-[rgba(255,255,255,0.08)] rounded-3xl shadow-premium">
                <h2 className="text-2xl font-bold text-[#F8FAFC] font-display mb-2 font-sans">
                ...
                {!submitted ? (
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 text-left">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 rounded-xl bg-[#111827] border text-[#F8FAFC] text-xs focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all ${
                            errors.name ? 'border-red-500/80' : 'border-[rgba(255,255,255,0.08)]'
                          }`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 rounded-xl bg-[#111827] border text-[#F8FAFC] text-xs focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all ${
                            errors.email ? 'border-red-500/80' : 'border-[rgba(255,255,255,0.08)]'
                          }`}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="text"
                          {...register('company')}
                          className="w-full px-4 py-3 rounded-xl bg-[#111827] border border-[rgba(255,255,255,0.08)] text-[#F8FAFC] text-xs focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                      ...
                      <div>
                        ...
                        <select
                          {...register('segment')}
                          className="w-full px-4 py-3 rounded-xl bg-[#111827] border border-[rgba(255,255,255,0.08)] text-[#F8FAFC] text-xs focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all appearance-none cursor-pointer"
                        >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className={`w-full px-4 py-3 rounded-xl bg-[#111827] border text-[#F8FAFC] text-xs focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all resize-none ${
                          errors.message ? 'border-red-500/80' : 'border-[rgba(255,255,255,0.08)]'
                        }`}
                    ...
                    <div className="pt-2">
                      <button
                        type="submit"
                        className="w-full py-4 rounded-xl bg-gradient-to-r from-primary to-accent hover:brightness-110 text-slate-950 font-bold text-xs uppercase tracking-wider shadow-lg hover:shadow-primary/20 flex items-center justify-center gap-2 cursor-pointer transition-colors"
                      >
                  ...
                  <div className="flex flex-col items-center justify-center text-center py-10 space-y-4">
                    ...
                    <p className="text-xs text-slate-405 max-w-sm">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-[#111827] border border-[rgba(255,255,255,0.08)] hover:bg-[#0F172A] text-xs font-semibold text-white transition-all cursor-pointer"
                    >
              ...
              <div className="h-[320px] rounded-3xl bg-[#0F172A] border border-[rgba(255,255,255,0.08)] shadow-premium relative flex items-center justify-center overflow-hidden p-6">
                ...
                <div className="relative text-center space-y-4 z-10 max-w-sm">
                  <MapPin size={40} className="text-accent mx-auto floating-element" />
                  <h3 className="text-lg font-bold text-white">Central Operations Mapping</h3>
